...
describe("transaction.js", function () {
  ...
  var transaction = persona.transaction;
  ...
  describe("#createTransaction", function () {
    ...
    describe("returned transaction", function () {
      ...
      it("should be signed correctly", function () {
        var result = persona.crypto.verify(trs);
        result.should.equal(true);
      });

      it("should be deserialised correctly", function () {
        var deserialisedTx = persona.crypto.fromBytes(persona.crypto.getBytes(trs).toString("hex"));
  ...
  describe("createTransaction and try to tamper signature", function(){
    ...
    it("should not validate overflown signatures", function(){
      ...
      */
      ...
      // console.log("TXID " + persona.crypto.getId(old_transaction));
      // console.log("VERIFY " + persona.crypto.verify(old_transaction));
      // console.log("SIG " + old_transaction.signature + "\n");

      persona.crypto.verify(old_transaction).should.equal(true);
      ...
      persona.crypto.verify(old_transaction).should.equal(false);
  ...
  describe("#createTransaction with second secret", function () {
    ...
    var keys = persona.crypto.getKeys(secondSecret);
    ...
    describe("returned transaction", function () {
      ...
      it("should be second signed correctly", function () {
        var result = persona.crypto.verifySecondSignature(trs, keys.publicKey);
        (result).should.equal(true);
      });
